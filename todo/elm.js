...
var _user$project$Main$encodeFilterStateAsJson = function (filterState) {
	return _elm_lang$core$Json_Encode$string(
		_elm_lang$core$Basics$toString(filterState));
};
var _user$project$Main$encodeTodoAsJson = function (todo) {
...
var _user$project$Main$encodeModelAsJson = function (model) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Main$encodeTodoAsJson, model.todos))
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'todo',
					_1: _user$project$Main$encodeTodoAsJson(model.todo)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'filter',
						_1: _user$project$Main$encodeFilterStateAsJson(model.filter)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Main$remainingTodos = function (todos) {
...
var _user$project$Main$todoWithCompletion = F2(
	function (todo, completion) {
		return _elm_lang$core$Native_Utils.update(
			todo,
			{completed: completion});
	});
var _user$project$Main$todoWithIdentifier = F2(
	function (todo, newIdentifier) {
		return _elm_lang$core$Native_Utils.update(
			todo,
			{identifier: newIdentifier});
	});
var _user$project$Main$todoWithTitle = F2(
	function (todo, newTitle) {
		return _elm_lang$core$Native_Utils.update(
			todo,
			{title: newTitle});
	});
var _user$project$Main$nextIdentifier = function (todos) {
	var _p1 = A2(
		...
		todos);
	if (_p1.ctor === 'Just') {
		return _p1._0.identifier + 1;
	} else {
		return 1;
	}
};
var _user$project$Main$emptyTodo = {title: '', completed: false, editing: false, identifier: 0};
...
var _user$project$Main$storageOutput = _elm_lang$core$Native_Platform.outgoingPort(
	'storageOutput',
	function (v) {
		return v;
	});
var _user$project$Main$sendToStorage = function (model) {
	return _user$project$Main$storageOutput(
		_user$project$Main$encodeModelAsJson(model));
};
		...
		switch (_p2.ctor) {
			case 'SetTodoTitle':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						todo: A2(_user$project$Main$todoWithTitle, model.todo, _p2._0)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
			...
			case 'Add':
				var newTodosList = {ctor: '::', _0: model.todo, _1: model.todos};
				var nextTodoIdentifier = _user$project$Main$nextIdentifier(newTodosList);
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						todos: newTodosList,
						todo: A2(_user$project$Main$todoWithIdentifier, _user$project$Main$emptyTodo, nextTodoIdentifier)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
			...
			case 'SetCompletion':
				var _p3 = _p2._1;
				var markTodoAsComplete = function (thisTodo) {
					return _elm_lang$core$Native_Utils.eq(thisTodo.identifier, _p3.identifier) ? A2(_user$project$Main$todoWithCompletion, _p3, _p2._0) : thisTodo;
				};
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						todos: A2(_elm_lang$core$List$map, markTodoAsComplete, model.todos)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						todos: A2(
							_elm_lang$core$List$filter,
							function (todo) {
								return !_elm_lang$core$Native_Utils.eq(todo.identifier, _p2._0.identifier);
							},
							model.todos)
					});
				return {
...
var _user$project$Main$initialModel = function () {
	...
	var nextTodoId = _user$project$Main$nextIdentifier(initialTodos);
	return {
		todos: initialTodos,
		todo: A2(_user$project$Main$todoWithIdentifier, _user$project$Main$emptyTodo, nextTodoId),
...
var _user$project$Main$DeleteCompletedTodos = {ctor: 'DeleteCompletedTodos'};
var _user$project$Main$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$Main$SetCompletion = F2(
	function (a, b) {
		return {ctor: 'SetCompletion', _0: a, _1: b};
	});
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onCheck(
											function (completion) {
												return A2(_user$project$Main$SetCompletion, completion, todo);
											}),
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$Main$SetTodoTitle = function (a) {
	return {ctor: 'SetTodoTitle', _0: a};
};
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetTodoTitle),
															_1: {ctor: '[]'}
														}
													}
												}
												...
												{ctor: '[]'},
												{
													...
													_0: _elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(
															_user$project$Main$remainingTodos(model.todos))),
													_1: {
														ctor: '::',
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$DeleteCompletedTodos),
														_1: {ctor: '[]'}
													}
												},
												{
