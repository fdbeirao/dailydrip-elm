...
var _user$project$Main$initialModel = {count: 0, totalIncrements: 0, totalDecrements: 0};
...
var _user$project$Main$storageInput = _elm_lang$core$Native_Platform.incomingPort(
	...
	A2(
		...
		function (count) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				function (totalIncrements) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						function (totalDecrements) {
							return _elm_lang$core$Json_Decode$succeed(
								{count: count, totalIncrements: totalIncrements, totalDecrements: totalDecrements});
						},
						A2(_elm_lang$core$Json_Decode$field, 'totalDecrements', _elm_lang$core$Json_Decode$int));
				},
				A2(_elm_lang$core$Json_Decode$field, 'totalIncrements', _elm_lang$core$Json_Decode$int));
		},
...
var _user$project$Main$storage = _elm_lang$core$Native_Platform.outgoingPort(
	'storage',
	function (v) {
		return {count: v.count, totalIncrements: v.totalIncrements, totalDecrements: v.totalDecrements};
	});
		...
		switch (_p0.ctor) {
			case 'Increment':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{count: model.count + 1, totalIncrements: model.totalIncrements + 1});
				return {
					ctor: '_Tuple2',
					_0: newModel,
			...
			case 'Decrement':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{count: model.count - 1, totalDecrements: model.totalDecrements + 1});
				return {
					ctor: '_Tuple2',
					_0: newModel,
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {count: a, totalIncrements: b, totalDecrements: c};
	});
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										...
										'Total increments: ',
										_elm_lang$core$Basics$toString(model.totalIncrements))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Total decrements: ',
											_elm_lang$core$Basics$toString(model.totalDecrements))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
